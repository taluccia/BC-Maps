...
map_legend2 = ggplot() +
  ...
  geom_sf(data = fire2, fill = NA, aes(color = "Fire2"), size = 1, show.legend = TRUE) +
  geom_sf(data = fire3, fill = NA, aes(color = "Fire3"), size = 1, show.legend = TRUE) +
  scale_color_manual(values = c("BC" = "#7E7E7E", "Parks" = "#75816B", "Lakes" = "#AADAFF", "Fire1" = "#3F4354", "Fire2" = "#C0C0C0", "Fire3" =  "#778899"), 
                       labels = c("British Columbia", "Chelaslie fire", "Entiako fire", "Tweedsmuir fire", "Lakes", "Provincial parks"),
                       name = "") +
...
fig_manuscript1 = ggdraw() +
   draw_plot(map_legend) +
  draw_plot(map_bc, x = 0.1, y = 0.2, width = .25, height = .25) 
...
map_fires_manuscript
```


```{r fig.height=4, fig.width=6}

map_bc_labels_manuscript = ggdraw() +
   draw_plot(map_fires_manuscript) +
  draw_plot(map_bc, x = 0.1, y = 0.2, width = .25, height = .25) +
  draw_label("Chelaslie\n(2014)", x = .4, y = .76, fontface = "plain", color = "black", size = 10) +
  draw_label("Chelaslie\n(2014)", x = .5, y = .55, fontface = "plain", color = "black", size = 10) +
  draw_label("Entiako\n(2012)", x = .58, y = .415, fontface = "plain", color = "black", size = 10, angle = 30) +
  draw_label("Tweedsmuir\n(2013)", x = .18, y = .6, fontface = "plain", color = "black", size = 10, angle = 30) 

map_bc_labels_manuscript


```

```{r}
ggsave("../figures/bc_map_labels_manuscript.png", plot = map_bc_labels_manuscript, width = 6, height = 4, dpi = 600)
```
